...
$(function(){
	...
	$('#pagination2').css('margin-left',(470-paginationwidth))
	...
	function DOTCHANGE(){
		...
		$('#slides2 li').eq(nownow).fadeOut(400,function(){$('#slides li').eq(changenow).fadeIn(500);});
		nownow = changenow;
	}
	...
	function GOGO(){
		...
		if( inout == 1 ){
			...
			$('#slides2 li').eq(nownow).fadeOut(400,function(){$('#slides li').eq(NN).fadeIn(500);});
			nownow += 1;
			...
			$('#slides2 li').eq(nownow).fadeOut(400,function(){$('#slides li').eq(0).fadeIn(500);});
			pagination.eq(NN).addClass('current').siblings('li').removeClass('current');
