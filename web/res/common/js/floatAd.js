(function($){
	$.fn.floatAd = function(options){
		var defaults = {
			imgSrc : "images/img_k.jpg", //漂浮图片路径
			url : "", //图片点击跳转页
		...
		var html = "<div id='float_ad' style='position:absolute;left:0px;top:0px;z-index:1000000;cleat:both;'>";
            html += "  <a href='" + options.imgJumpToUrl + "' " + _target + "><img src='" + options.imgSrc + "' border='0' class='float_ad_img'/></a> <a href='javascript:;' id='close_float_ad' class='xxf'>X</a>";
            html += "</div>";
