...
public abstract class BaseChannel  implements Serializable {
	...
	public BaseChannel (
		...
		com.portal.cms.entity.main.CmsModel model,
	...
	// one to one
	private com.portal.cms.entity.main.ChannelExt channelExt;
	private com.portal.cms.entity.main.ChannelCount channelCount;

	// many to one
	private com.portal.core.entity.CmsSite site;
	private com.portal.cms.entity.main.CmsModel model;
	private com.portal.cms.entity.main.Channel parent;

	// collections
	private java.util.Set<com.portal.cms.entity.main.Channel> child;
	private java.util.Set<com.portal.core.entity.CmsGroup> viewGroups;
	private java.util.Set<com.portal.core.entity.CmsGroup> contriGroups;
	private java.util.Set<com.portal.core.entity.CmsUser> users;
	private java.util.Set<com.portal.cms.entity.main.ChannelTxt> channelTxtSet;
	private java.util.List<com.portal.cms.entity.main.ChannelModel> channelModels;
	 ...
	 */
	public com.portal.cms.entity.main.ChannelExt getChannelExt () {
		return channelExt;
	}
	 ...
	 */
	public void setChannelExt (com.portal.cms.entity.main.ChannelExt channelExt) {
		this.channelExt = channelExt;
	}
	
	public com.portal.cms.entity.main.ChannelCount getChannelCount() {
		return channelCount;
	}

	public void setChannelCount(com.portal.cms.entity.main.ChannelCount channelCount) {
	 ...
	 */
	public com.portal.cms.entity.main.Channel getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.portal.cms.entity.main.Channel parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.portal.cms.entity.main.Channel> getChild () {
		return child;
	}
	 ...
	 */
	public void setChild (java.util.Set<com.portal.cms.entity.main.Channel> child) {
		this.child = child;
	}
	 ...
	 */
	public java.util.Set<com.portal.core.entity.CmsGroup> getContriGroups () {
		return contriGroups;
	}
	 ...
	 */
	public void setContriGroups (java.util.Set<com.portal.core.entity.CmsGroup> contriGroups) {
	 ...
	 */
	public java.util.Set<com.portal.core.entity.CmsUser> getUsers () {
		return users;
	}
	 ...
	 */
	public void setUsers (java.util.Set<com.portal.core.entity.CmsUser> users) {
		this.users = users;
	}
	/**
	 * Return the value associated with the column: channelTxtSet
	 */
	public java.util.Set<com.portal.cms.entity.main.ChannelTxt> getChannelTxtSet () {
	 ...
	 */
	public void setChannelTxtSet (java.util.Set<com.portal.cms.entity.main.ChannelTxt> channelTxtSet) {
		this.channelTxtSet = channelTxtSet;
	}

	public java.util.List<com.portal.cms.entity.main.ChannelModel> getChannelModels() {
		return channelModels;
	}

	public void setChannelModels(
			java.util.List<com.portal.cms.entity.main.ChannelModel> channelModels) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.portal.cms.entity.main.Channel)) return false;
		else {
			com.portal.cms.entity.main.Channel channel = (com.portal.cms.entity.main.Channel) obj;
